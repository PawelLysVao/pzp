...
import { PartialSearchingProps, PaginationParams, SearchParams } from 'modules/Shared/type';
...
export class UserFilter extends React.Component<Props> {
  ...
  render(): ReactNode {
    ...
    return <ListingFilter inputs={this.staticInputs} filter={filter} pagination={pagination} setParams={setParams} />;
  }
}

export default connect<StateProps, DispatchProps>(mapState, mapDispatch)(UserFilter);
